...
export default function ResumePage() {
  ...
  const nameLetters = "Hemanth Reddy Yarraguravagari Resume ".split("");
                    ...
                    <div className="space-y-4 sm:space-y-6 flex-1">
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">
                          My resume highlights expertise in data engineering, ServiceNow development, 
                          and software applications. I specialize in designing ETL/ELT pipelines, 
                          implementing ServiceNow solutions, and developing data-driven applications 
                          using Python, SQL, JavaScript, and cloud technologies.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-neutral-400 space-y-2 list-disc pl-5">
                          <li>
                            ...
                            professional journey at DXC Technology and SALIGRAM TECHNOLOGIES
                          </li>
                          <li>
                            The &quot;Skills&quot; section outlines my expertise in Python, SQL, 
                            ServiceNow, AWS/Azure, and data engineering
                          </li>
                          <li>
                            See &quot;Education&quot; for my Master's degree progress at Florida International University
                          </li>
                          <li>
                            View &quot;Certifications&quot; for my ServiceNow and AWS credentials
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">
                          I bring 4+ years of diverse technical experience with a strong foundation in 
                          data engineering and ServiceNow development. My ability to design enterprise-level 
                          ETL/ELT pipelines, implement ServiceNow solutions, and optimize data infrastructure 
                          has consistently enhanced operational efficiency and reduced costs for organizations.
                        </p>
                      </div>
                    </div>
